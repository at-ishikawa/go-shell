...
func (m *MockPlugin) GetContext(command string) (map[string]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetContext", command)
...
func (mr *MockPluginMockRecorder) GetContext(command interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetContext", reflect.TypeOf((*MockPlugin)(nil).GetContext), command)
}

// Suggest mocks base method.
func (m *MockPlugin) Suggest(arg SuggestArg) ([]string, error) {
	m.ctrl.T.Helper()
